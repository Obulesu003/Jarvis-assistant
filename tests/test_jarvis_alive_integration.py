...
class TestIntegrationTurnModel:
    ...
    def test_memory_bridge_preferences_context(self):
    ...
    def test_conversation_topic_extraction(self):
        ...
        # Topic should update to reminder-related
        assert ctx.last_topic is not None

    def test_interrupted_text_preservation(self):
    ...
    def test_memory_bridge_empty_context(self):
    ...
    def test_visual_presence_state_colors(self):
    ...
    def test_should_not_volunteer_when_recently_volunteered(self):
        ...
        # But volunteered recently
        ctx.last_volunteer_at = time.time() - 100  # Only 100 seconds ago

        assert ctx.should_volunteer() is False

    def test_should_not_volunteer_when_not_idle_long_enough(self):
        ...
        # Only idle for 2 minutes (need 5)
